...
// Ordre : les 4 premiers sont affichés, le reste est masqué sous "Voir plus"
// Visible = 1K, 2K, 5K, 10K (comme myboost.fr) ; Masqués = intermédiaires + grands
const QUANTITIES: Record<string, number[]> = {
  // Instagram
  instagram_abonnes:        [30, 1000, 2000, 5000,  10000, 3000, 4000, 6000, 7000, 8000, 9000, 50000, 75000, 100000, 500000, 1000000],
  ...
  // TikTok
  tiktok_abonnes:           [1000, 2000, 5000, 10000,  3000, 4000, 6000, 7000, 8000, 9000, 50000, 75000, 100000],
  tiktok_likes:             [1000, 2000, 5000, 10000,  3000, 4000, 6000, 7000, 8000, 9000],
  tiktok_vues:              [1000, 2500, 5000, 10000,  7500, 15000, 20000, 25000, 50000, 100000, 500000, 1000000],
  tiktok_enregistrements:   [1000, 2000, 5000, 10000,  3000, 4000, 6000, 7000, 8000, 9000],
  tiktok_partages:          [1000, 2000, 5000, 10000,  3000, 4000, 6000, 7000, 8000, 9000],
  tiktok_commentaires:      [5, 10, 25, 50,  100, 250, 500],
  // YouTube
  youtube_abonnes:          [1000, 2000, 5000, 10000,  3000, 4000, 6000, 7000, 8000, 9000],
  youtube_likes:            [100, 250, 1000, 5000,  500, 2000, 3000, 4000, 6000, 7000, 8000, 9000, 10000],
  ...
  // Facebook
  facebook_abonnes:         [1000, 2000, 5000, 10000,  3000, 4000, 6000, 7000, 8000, 9000],
  facebook_likes:           [100, 250, 1000, 5000,  500, 2000, 3000, 4000, 6000, 7000, 8000, 9000, 10000],
  facebook_vues:            [1000, 2500, 5000, 10000,  20000, 50000, 100000],
  // Spotify
  spotify_auditeurs:        [500, 1000, 5000, 10000,  2500, 25000, 50000],
  spotify_vues:             [1000, 2500, 5000, 10000,  25000, 50000, 100000, 150000, 300000, 500000, 1000000],
  spotify_abonnes:          [500, 1000, 5000, 10000,  2500, 25000, 50000],
  // Twitter/X
  twitter_abonnes:          [100, 250, 1000, 5000,  500, 2000, 10000],
  twitter_likes:            [100, 250, 1000, 5000,  500, 2000, 3000, 4000, 6000, 7000, 8000, 9000, 10000],
  twitter_retweets:         [100, 250, 1000, 5000,  500, 2000, 3000, 4000, 6000, 7000, 8000, 9000, 10000],
  // Threads
  threads_likes:            [100, 250, 1000, 5000,  500, 2000, 3000, 4000, 6000, 7000, 8000, 9000, 10000],
  threads_abonnes:          [100, 250, 1000, 5000,  500, 2000, 10000],
  // Fallbacks génériques
  abonnes:        [1000, 2000, 5000, 10000,  3000, 4000, 6000, 7000, 8000, 9000],
  likes:          [100, 250, 1000, 5000,  500, 2000, 3000, 4000, 6000, 7000, 8000, 9000, 10000],
  vues:           [1000, 2500, 5000, 10000,  25000, 50000, 100000, 500000, 1000000],
  commentaires:   [5, 10, 25, 50,  100, 250, 500],
  partages:       [1000, 2000, 5000, 10000,  3000, 4000, 6000, 7000, 8000, 9000],
  enregistrements:[1000, 2000, 5000, 10000,  3000, 4000, 6000, 7000, 8000, 9000],
  retweets:       [100, 250, 1000, 5000,  500, 2000, 3000, 4000, 6000, 7000, 8000, 9000, 10000],
  auditeurs:      [500, 1000, 5000, 10000,  2500, 25000, 50000],
};
